...
public struct AppearanceSettingsView: View {
    ...
    private let options: [ThemeOption] = [
        ThemeOption(id: "Dark", label: SettingsConstants.Appearance.darkLabel, sub: SettingsConstants.Appearance.darkSub, available: true, isLight: false, isMixed: false),
        ThemeOption(id: "Light", label: SettingsConstants.Appearance.lightLabel, sub: SettingsConstants.Appearance.lightSub, available: false, isLight: true, isMixed: false),
        ThemeOption(id: "System", label: SettingsConstants.Appearance.systemLabel, sub: SettingsConstants.Appearance.systemSub, available: false, isLight: false, isMixed: true)
    ]

    public init() {}

    public var body: some View {
        SettingsScreen(title: SettingsConstants.Appearance.title) {
            ...
            Text(SettingsConstants.Appearance.footer)
                .font(.appBody)
            ...
            HStack(spacing: AppSpacing.md) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    HStack {
                        ...
                        if !option.available {
                            Text(SettingsConstants.Appearance.comingSoon)
...
public struct LanguageSettingsView: View {
    ...
    public var body: some View {
        SettingsScreen(title: SettingsConstants.Language.title) {
            SearchField(text: $searchText, placeholder: SettingsConstants.Language.searchPlaceholder)
                .padding(.top, AppSpacing.md)

            SettingsListHeader(SettingsConstants.Language.currentHeader)
            SettingsListGroup {
                SettingsListRow(
                    label: "English (US)",
                    sub: "English",
            ...
            SettingsListHeader(SettingsConstants.Language.allHeader)
            SettingsListGroup {
            ...
            Text(SettingsConstants.Language.restartFooter)
                .font(.appBody)
                .foregroundStyle(AppColor.textSecondary)
                .padding(.top, AppSpacing.lg)
        }
